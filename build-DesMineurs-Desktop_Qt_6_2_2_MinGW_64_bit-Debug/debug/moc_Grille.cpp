...
QT_MOC_LITERAL(7, 12), // "digitClicked"
QT_MOC_LITERAL(20, 0), // ""
QT_MOC_LITERAL(21, 5), // "Case*"
QT_MOC_LITERAL(27, 2), // "cs"
QT_MOC_LITERAL(30, 14), // "bouttonCliquer"
QT_MOC_LITERAL(45, 14) // "onRightClicked"

    },
    "Grille\0digitClicked\0\0Case*\0cs\0"
    "bouttonCliquer\0onRightClicked"
};
...
void Grille::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->digitClicked((*reinterpret_cast< Case*(*)>(_a[1]))); break;
        case 1: _t->bouttonCliquer(); break;
        case 2: _t->onRightClicked(); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< Case* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Grille::*)(Case * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Grille::digitClicked)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Grille, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<Case *, std::false_type>
...
// SIGNAL 0
void Grille::digitClicked(Case * _t1)
{
